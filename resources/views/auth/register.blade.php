    ...
    <div class="container">
        ...
        <div class="left-side">
            <div class="logo-container">
                ...
                <p>Bergabunglah dengan kami dan nikmati kemudahan dalam melakukan booking ruangan dan fasilitas kampus.</p>
            </div>
        </div>
        ...
        <div class="right-side">
            ...
            <p class="subtitle">Daftar untuk mulai melakukan booking</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group">
                    <label for="instansi">Instansi / Fakultas</label>
                    <input id="instansi" type="text" name="instansi" value="{{ old('instansi') }}" 
                           placeholder="Contoh: Fakultas Farmasi, PT. ABC" required>
                    @error('instansi')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
