                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" name="search" class="form-control"
                                    placeholder="Cari kode peminjaman atau peminjam..." value="{{ request('search') }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <select name="status_verifikasi" class="form-select">
                                ...
                                <option value="belum_verifikasi"
                                    {{ request('status_verifikasi') == 'belum_verifikasi' ? 'selected' : '' }}>
                                    Belum Diverifikasi
                                </option>
                                ...
                                <option value="pending" {{ request('status_verifikasi') == 'pending' ? 'selected' : '' }}>
                                    Sudah Diverifikasi - Pending
                                </option>
                                <option value="perlu_tindakan"
                                    {{ request('status_verifikasi') == 'perlu_tindakan' ? 'selected' : '' }}>
                                    Sudah Diverifikasi - Perlu Tindakan
                                </option>
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                            @if (request()->hasAny(['search', 'status_verifikasi']))
                                <a href="{{ route('pic.verifikasi-pengembalian.index') }}"
                        ...
                        <tbody>
                            @forelse($pengembalian as $index => $item)
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        @if ($item->verifikasi)
                                            @if($item->verifikasi->status_verifikasi == 'diterima')
                                                <span class="badge bg-success px-3 py-2">
                                                    <i class="fas fa-check-circle me-1"></i>Diterima
                                                </span>
                                            @elseif($item->verifikasi->status_verifikasi == 'pending')
                                            ...
                                            <div class="text-muted small mt-1">
                                                @if($item->verifikasi->kondisi == 'baik')
                                                    Baik
                                                @elseif($item->verifikasi->kondisi == 'rusak_ringan')
                                                    Rusak Ringan
