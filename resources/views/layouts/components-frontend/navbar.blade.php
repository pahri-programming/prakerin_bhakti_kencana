<header>
    <nav class="navbar navbar-expand-lg py-3" id="mainNav">
        <style>
            ...
            .nav-link-custom.active { color: #2563eb !important; }
            ...
            .denda-dropdown .dropdown-item:hover { background: #f3f4f6; }
            ...
            .avatar-circle:hover { border-color: #2563eb; }
            ...
            .dropdown-item-custom:hover { background: #f3f4f6; color: #111; }
        </style>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav mx-auto gap-lg-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom {{ request()->routeIs('riwayat.*') ? 'active' : '' }}"
                            href="{{ route('riwayat.index') }}">Riwayat</a>
                    </li>
                    @endauth
                </ul>
                ...
                <ul class="navbar-nav ms-auto">
                    @guest
                        <li class="nav-item">
                            <a href="{{ route('login') }}"
                                class="btn btn-primary rounded-pill px-4 fw-semibold" style="font-size:.875rem;">
                                Login
                            </a>
                        </li>
                    @else
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link p-0 d-flex align-items-center gap-2"
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-custom"
                                ...
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="btn btn-outline-danger w-100 rounded-pill btn-sm mt-1">
