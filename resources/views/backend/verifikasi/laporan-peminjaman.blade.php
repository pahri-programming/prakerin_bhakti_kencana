                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <select name="kondisi" class="form-select">
                                ...
                                <option value="rusak_ringan" {{ request('kondisi') == 'rusak_ringan' ? 'selected' : '' }}>⚠️
                                    Rusak Ringan</option>
                                <option value="rusak_berat" {{ request('kondisi') == 'rusak_berat' ? 'selected' : '' }}>🔴
                                    Rusak Berat</option>
                                <option value="hilang" {{ request('kondisi') == 'hilang' ? 'selected' : '' }}>❌ Hilang
                                </option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            ...
                            <select name="status" class="form-select">
                                ...
                                <option value="perlu_tindakan"
                                    {{ request('status') == 'perlu_tindakan' ? 'selected' : '' }}>⚡ Perlu Tindakan</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('backend.verifikasi.laporan.peminjaman') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-info btn-detail"
                                            data-id="{{ $v->id }}" data-kode="{{ $v->peminjaman->kode }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="card bg-light">
                                    <div class="card-body py-2">
                                        ...
                                        <span>{{ $verifikasi->catatan_pic ?? '-' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form id="formTindakan" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="tindakan_admin" id="modal-tindakan-input" class="form-control" rows="4"
                                        placeholder="Contoh: Tagih biaya penggantian Rp 5.000.000 ke user. Ganti dengan unit baru." required></textarea>
