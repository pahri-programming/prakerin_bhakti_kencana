...
@section('title', 'Tagihan Denda Booking')
...
<style>
    ...
    .stat-card { background: #fff; border-radius: 14px; padding: 1.25rem 1.5rem; box-shadow: 0 2px 10px rgba(0,0,0,.06); }
    ...
    .denda-card {
        ...
        border-left: 5px solid #dee2e6; transition: transform .2s, box-shadow .2s;
    }
    ...
    .badge-status { display: inline-flex; align-items: center; gap: 5px; padding: 5px 12px; border-radius: 20px; font-size: .78rem; font-weight: 700; }
    ...
    .empty-state { background: #fff; border-radius: 14px; padding: 4rem 2rem; text-align: center; box-shadow: 0 2px 10px rgba(0,0,0,.06); }
...
<div class="col-xl-9 col-lg-10">
    ...
    <div class="page-hero">
        ...
        <h4><i class="fas fa-building me-2"></i>Tagihan Denda Booking</h4>
        <p>Daftar denda booking ruangan yang perlu diselesaikan</p>
    </div>
    ...
    @forelse($dendas as $denda)
        @php $status = $denda->status_pembayaran; @endphp
            ...
            <div class="row align-items-center g-3">
                <div class="col-md-8">
                    ...
                    <div class="fw-bold mb-1" style="font-size:.95rem; color:#1e293b;">
                        {{ $denda->booking->ruangan->nama_ruangan ?? '-' }}
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-3 mt-2">
                        ...
                        <span style="font-size:.83rem; color:#64748b;">
                            ...
                            Kondisi: <strong>{{ ucfirst($denda->verifikasiBooking->kondisi_ruangan ?? '-') }}</strong>
                        </span>
                    </div>
                </div>
                <div class="col-md-4 d-flex justify-content-md-end">
                    <a href="{{ route('user.denda-booking.show', $denda->id) }}"
    ...
    @empty
        <div class="empty-state">
            <i class="fas fa-check-circle text-success d-block mb-3" style="font-size:3rem;"></i>
            <h5 class="fw-semibold text-muted">Tidak ada tagihan denda booking</h5>
            <p class="text-muted small">Semua booking ruangan Anda berjalan baik tanpa denda.</p>
        </div>
    @endforelse
