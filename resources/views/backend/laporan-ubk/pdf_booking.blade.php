...
<body>
    ...
    <div class="header">
        ...
        <div class="title-sub">Riwayat Booking Ruangan</div>
        <div class="info"><strong>Periode:</strong> {{ $periode }}</div>
        <div class="info"><strong>Total Booking:</strong> {{ $total }}</div>
    </div>
        ...
        <tbody>
            @forelse ($data as $i => $d)
                <tr>
                    ...
                    @php
                        $statusClass = 'status-' . ($d->status_laporan ?? 'unknown');
                    @endphp

                    <td>
                        <span class="status {{ $statusClass }}">{{ $d->status_laporan }}</span>
                    </td>
