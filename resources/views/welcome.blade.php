                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        ...
                        <a href="{{ route('bookings.create') }}"
                            class="btn btn-primary btn-lg rounded-pill shadow-sm px-4 py-3 btn-hover">
                            <i class="bi bi-calendar-plus me-2"></i> Booking Sekarang
                        </a>
                    </div>
                    <div class="col-lg-6 text-center">
                        <div class="image-container position-relative">
                            <img src="{{ asset('assets/backend/images/bku.jpeg') }}" alt="Ilustrasi Ruangan"
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventDidMount: function(info) {
                    ...
                    if (title.includes('Booking')) {
                        icon = '<i class="bi bi-calendar-check me-1"></i>';
                    } else {
                ...
                eventClick: function(info) {
                    ...
                    // Show modal or alert with event details
                    const modal = new bootstrap.Modal(document.getElementById('eventModal'));
                    document.getElementById('eventModalLabel').textContent = info.event.title;
                    document.getElementById('eventModalBody').innerHTML = info.event.extendedProps
