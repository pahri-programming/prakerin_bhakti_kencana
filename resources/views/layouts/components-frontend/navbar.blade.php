                                    ...
                                    <li>
                                        <a class="dropdown-item small py-2 px-3" href="{{ route('bookings.riwayat') }}">
                                            @if ($notif->status == 'Diterima')
                                                ✅ Booking untuk <strong>{{ $notif->ruangan->nama_ruangan }}</strong> telah <span
                                                    class="text-success">DITERIMA</span>.
                                            @elseif ($notif->status == 'Ditolak')
                                                ❌ Booking untuk <strong>{{ $notif->ruangan->nama_ruangan }}</strong> <span
                                                    class="text-danger">DITOLAK</span>.
                                            @endif
